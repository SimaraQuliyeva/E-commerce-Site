                        ...
                        <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
                            <div class="block-4 text-center border">
                                <figure class="block-4-image">
                                    <a href="{{route('front.product.details')}}"><img src='{{asset("front/images/cloth_1.jpg") }}' alt="Image placeholder" class="img-fluid"></a>
                                </figure>
                                <div class="block-4-text p-4">
                                    <h3><a href="{{route('front.product.details')}}">Tank Top</a></h3>
